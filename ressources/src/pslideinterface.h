...
public:
    ...
    /**
      ...
      */
    static void initialize(unsigned int nbConsoles,unsigned int nbStep);
    ...
    //! Retourne le nombre de marches du toboggan en incluant la rampe du toboggan
    //! qui est considérée comme une marche
...
signals:
    ...
    /**
      ...
      \param ms Nombre de millisecondes de l'animation.
      */
    void sig_play(unsigned int kidId,unsigned int ms);
