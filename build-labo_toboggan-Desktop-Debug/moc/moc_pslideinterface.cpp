...
void PSlideInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PSlideInterface::sig_consoleAppendText)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PSlideInterface::sig_travel)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PSlideInterface::sig_play)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject PSlideInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PSlideInterface.data,
      qt_meta_data_PSlideInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PSlideInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PSlideInterface.stringdata0))
        return static_cast<void*>(const_cast< PSlideInterface*>(this));
